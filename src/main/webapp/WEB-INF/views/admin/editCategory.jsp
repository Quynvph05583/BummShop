		...
		<div class="page-content-wrapper">
			<div class="page-content">
				<h3 class="wrapper-title">
					<spring:message code="label.edit.category" />
				</h3>
				<div class="wrapper-bar">
					<ul class="wrapper-breadcrumb">
						...
						<li><span class="breadcrumb-sub breadcrumb-sub-after"><spring:message
							...
							aria-hidden="true"></i></li>
						<li><span class="breadcrumb-sub breadcrumb-sub-after"><spring:message
									code="label.edit.category" /></span></li>
					</ul>
				</div>
				<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<span class="field-title"><spring:message
													code="label.name" /> </span> <input required="required" name="name" type="text"
												value="${editCategory.name}" class="form-input">
										</div>
									</div>
								</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											<div class="button-group button-group-right">
												...
												<a href="${pageContext.request.contextPath}/admin/listCategory" type="button" class="button btn-cancel">
							...
							$("#locales")
									.change(
											function() {
												...
												if (selectedOption) {
													window.location
															.replace('${pageContext.request.contextPath}/admin/editCategory/${editCategory.id}?lang='
																	+ selectedOption);
